...
assert.ok(existsSync(new URL("../ios/AiDiet/Resources/灵光.html", import.meta.url)), "bundled HTML resource exists");
...
assert.match(viewController, /forResource: "灵光"/, "WKWebView loads the actual bundled HTML filename");
